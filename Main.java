...
public class Main {
    ...
    public static void submenuCadastroVeiculo(Scanner ler) {
        ...
        do {
            ...
            System.out.println("1. Validação da placa do veículo");
            System.out.println("2. Geração automática de placa no padrão Mercosul");
            ...
            switch (opcao) {
                case 1:
                    System.out.println(">> Validação de placa selecionada.");
                    break;
                case 2:
                    System.out.println(">> Geração de placa padrão Mercosul selecionada.");
                    break;
                case 3:
